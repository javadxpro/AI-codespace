...
#define KIMIA_ENGINE_VERSION "0.16.1"
...
inline constexpr u32 kEngineVersionMinor = 16U;
inline constexpr u32 kEngineVersionPatch = 1U;

// "KIMIA 0.16.1" — for banners and --version.
