...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 385/385 → دستور بعدی
...
./build/bin/kimia_tests      # 385/385 tests passed
...
./build-nosdl/bin/kimia_tests    # 385/385 tests passed
```
