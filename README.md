...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 408/408 → دستور بعدی
...
./build/bin/kimia_tests      # 408/408 tests passed
...
./build-nosdl/bin/kimia_tests    # 408/408 tests passed
```
