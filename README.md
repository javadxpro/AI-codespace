...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 261/261 → دستور بعدی
...
./build/bin/kimia_tests      # 261/261 tests passed
...
./build-nosdl/bin/kimia_tests    # 261/261 tests passed
```
