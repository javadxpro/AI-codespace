...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 315/315 → دستور بعدی
...
./build/bin/kimia_tests      # 315/315 tests passed
...
./build-nosdl/bin/kimia_tests    # 315/315 tests passed
```
