...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 389/389 → دستور بعدی
...
./build/bin/kimia_tests      # 389/389 tests passed
...
./build-nosdl/bin/kimia_tests    # 389/389 tests passed
```
