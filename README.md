...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 352/352 → دستور بعدی
...
./build/bin/kimia_tests      # 352/352 tests passed
...
./build-nosdl/bin/kimia_tests    # 352/352 tests passed
```
