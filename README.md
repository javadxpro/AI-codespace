...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 273/273 → دستور بعدی
...
./build/bin/kimia_tests      # 273/273 tests passed
...
./build-nosdl/bin/kimia_tests    # 273/273 tests passed
```
