...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 248/248 → دستور بعدی
...
./build/bin/kimia_tests      # 248/248 tests passed
...
./build-nosdl/bin/kimia_tests    # 248/248 tests passed
```
