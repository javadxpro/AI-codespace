...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 281/281 → دستور بعدی
...
./build/bin/kimia_tests      # 281/281 tests passed
...
./build-nosdl/bin/kimia_tests    # 281/281 tests passed
```
