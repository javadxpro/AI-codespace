...
**نسخهٔ موتور: `0.1.0`** (`kimia_world --version`؛ شماره با اندازهٔ تغییر جلو می‌رود: باگ/کوچک `+0.0.1`، مرحله/بزرگ `+0.1.0`) — دفترچهٔ نسخه‌ها: [CHANGELOG.md](CHANGELOG.md).
...
./build/bin/kimia_tests      # 198/198 tests passed
...
./build-nosdl/bin/kimia_tests    # 198/198 tests passed
```
