...
**نسخهٔ موتور: `1405.06.14.3`** (= تاریخ شمسی انتشار؛ `kimia_world --version`) — دفترچهٔ نسخه‌ها: [CHANGELOG.md](CHANGELOG.md).
...
./build/bin/kimia_tests      # 196/196 tests passed
...
./build-nosdl/bin/kimia_tests    # 196/196 tests passed
```
