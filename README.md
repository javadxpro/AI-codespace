...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 336/336 → دستور بعدی
...
./build/bin/kimia_tests      # 336/336 tests passed
...
./build-nosdl/bin/kimia_tests    # 336/336 tests passed
```
