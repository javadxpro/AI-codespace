...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 239/239 → دستور بعدی
...
./build/bin/kimia_tests      # 239/239 tests passed
...
./build-nosdl/bin/kimia_tests    # 239/239 tests passed
```
