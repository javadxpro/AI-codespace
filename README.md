...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 357/357 → دستور بعدی
...
./build/bin/kimia_tests      # 357/357 tests passed
...
./build-nosdl/bin/kimia_tests    # 357/357 tests passed
```
