...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 251/251 → دستور بعدی
...
./build/bin/kimia_tests      # 251/251 tests passed
...
./build-nosdl/bin/kimia_tests    # 251/251 tests passed
```
