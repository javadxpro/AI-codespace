...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 250/250 → دستور بعدی
...
./build/bin/kimia_tests      # 250/250 tests passed
...
./build-nosdl/bin/kimia_tests    # 250/250 tests passed
```
