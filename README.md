...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 377/377 → دستور بعدی
...
./build/bin/kimia_tests      # 377/377 tests passed
...
./build-nosdl/bin/kimia_tests    # 377/377 tests passed
```
