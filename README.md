...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 297/297 → دستور بعدی
...
./build/bin/kimia_tests      # 297/297 tests passed
...
./build-nosdl/bin/kimia_tests    # 297/297 tests passed
```
