...
**نسخهٔ موتور: `1405.06.14.2`** (= تاریخ شمسی انتشار؛ `kimia_world --version`) — دفترچهٔ نسخه‌ها: [CHANGELOG.md](CHANGELOG.md).
...
| --- | --- | --- | --- | --- | --- |
| ۱ | **گلف** | آزمایش و یادگیری موتور — فیزیک، منطق بازی را به چالش می‌کشد | `kimia_golf` (بازی مرجع) → پروفایل | زمین آزاد | دقیق |
