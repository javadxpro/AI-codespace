...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 289/289 → دستور بعدی
...
./build/bin/kimia_tests      # 289/289 tests passed
...
./build-nosdl/bin/kimia_tests    # 289/289 tests passed
```
