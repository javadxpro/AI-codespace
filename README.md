...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 310/310 → دستور بعدی
...
./build/bin/kimia_tests      # 310/310 tests passed
...
./build-nosdl/bin/kimia_tests    # 310/310 tests passed
```
