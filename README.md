...
cd AI-codespace
bash Tools/termux_build.sh          # ابزار → cmake → build → 329/329 → دستور بعدی
...
./build/bin/kimia_tests      # 329/329 tests passed
...
./build-nosdl/bin/kimia_tests    # 329/329 tests passed
```
